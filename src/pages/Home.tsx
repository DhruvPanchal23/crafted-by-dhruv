...
const Home = () => {
  ...
  const welcomeTexts = ["Welcome", "स्वागत", "સ્વાગત"];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 animate-fade-in">
            <div className="space-y-4">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                <span className="gradient-text">Pixels, Logic and Story</span>
                <br />
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-primary font-medium typewriter">
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative">
              <div className="w-80 h-80 rounded-full overflow-hidden border-4 border-primary/20 shadow-glow animate-float">
                <img 
                  src={dhruvPortrait} 
                  alt="Dhruv Panchal" 
